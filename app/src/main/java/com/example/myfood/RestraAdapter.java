...
public class RestraAdapter extends RecyclerView.Adapter<RestraAdapter.ProductViewHolder> {
    ...
    public void onBindViewHolder(ProductViewHolder holder, int position) {
        ...
        holder.address.setText(restra.getAdd());
         holder.restra_name.setText(restra.getName());
        holder.cat1.setText(restra.getCat1());
        holder.cat2.setText(restra.getCat2());
        holder.cat3.setText(String.valueOf(restra.getCat3()));
        holder.rate.setRating(Float.parseFloat(restra.getRate()));
        holder.time.setText(String.valueOf(restra.getTme())+" min");
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView address, restra_name,cat1,cat2,cat3,time;
        ImageView imageView;
        RatingBar rate;
        ...
        public void onClick(View v) {
           ...
           intent.putExtra("img",product.getImage());
            ...
            intent.putExtra("loc",product.getAdd());
